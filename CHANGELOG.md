...
from, generates its own satellite data, and gives up two secrets it had been keeping about its
language — one of which had been reporting success while doing nothing at all.
