...
object ActionCatalog {
    val all: List<ActionDefinition> = listOf(
        ...
        define("huawei.time", ActionCategory.SYSTEM, ActionRetrySafety.IDEMPOTENT, ::HuaweiTimeAction),
        ...
        define("backup.export", ActionCategory.APP, ActionRetrySafety.NEVER, ::BackupDoorExportAction),
