...
✅ **FOSS geofence source/evaluator** — Location context matching supports platform GPS/network fixes, balanced provider cadence, policy disclosures, radius, accuracy, persisted dwell checks, stale-key cleanup, and inspector dwell detail without Play Services
...
2. **Geofence durability** — device-backed battery measurement, foreground/background device evidence, and reliability claims
