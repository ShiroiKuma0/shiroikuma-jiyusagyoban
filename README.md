...
✅ **Scene element editor** — Room-backed scene list/create/delete plus button, text, slider, and image element editing with tap/long-press task bindings and scaled canvas previews
...
3. **Scene drag/drop editor** — direct layout mutation after the form-backed editor is stable
