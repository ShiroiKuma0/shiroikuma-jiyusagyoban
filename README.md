...
✅ **Locale plugin host baseline** — explicit setting-plugin dispatch and condition-plugin query execution with package validation, bundle limits, result parsing, last-known unknown-state fallback, and timeout wrapping
