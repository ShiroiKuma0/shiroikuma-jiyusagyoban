...
✅ **Locale plugin host baseline** — explicit setting-plugin dispatch, condition-plugin query execution, configuration result parsing, package validation, bundle limits, last-known unknown-state fallback, and timeout wrapping
