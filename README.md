...
✅ **FOSS geofence source/evaluator** — Location context matching supports platform GPS/network fixes, balanced provider cadence, policy disclosures, radius, accuracy, persisted dwell checks, stale-key cleanup, inspector dwell detail, a Location evidence template, and adb evidence collection without Play Services
...
2. **Geofence durability** — longer device-backed battery measurement, background-location behavior evidence, and reliability claims
