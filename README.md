...
✅ **FOSS geofence source/evaluator** — Location context matching supports platform GPS/network fixes, radius, accuracy, persisted dwell checks, and inspector dwell detail without Play Services
...
2. **Geofence durability** — battery tuning, policy copy, stale-key cleanup, and device-verified background behavior
