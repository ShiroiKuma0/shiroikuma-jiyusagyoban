...
Source-backed product roadmap for OpenTasker v0.2.38. This file reconciles the current local repository state with competitive research across Android automation apps, adjacent workflow engines, Android platform constraints, distribution policy, and dependency changelogs.

**Last updated:** 2026-05-05
**Roadmap version:** 2026.05 research pass  
**Current app version:** 0.2.38
...
| Contexts | Time ticks use app-owned AlarmManager scheduling, WiFi events use dynamic NetworkCallback, app-open events use foreground-service-owned UsageStats polling, notification posts can emit filtered Event contexts, NFC tag scans can emit tag-filtered Event contexts, local calendar/sun ticks can emit filtered Event contexts, and Location contexts can receive platform GPS/network fixes with persisted dwell metadata and inspector dwell detail; remaining context work is day schedule polish, battery tuning, and device verification | Permission/onboarding and platform-safe replacements remain P0/P1 |
