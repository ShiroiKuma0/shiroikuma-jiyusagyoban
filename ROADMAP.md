...
The 2026-05-05 roadmap's `Now (N1–N10)`, `Next (X1–X12)`, and parts of `Later (L1, L2, L4, L6, L7)` were delivered between v0.2.2 and v0.2.59. Each item below cross-references the release that closed it; release notes are canonical for change-level detail.
