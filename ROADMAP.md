...
README rewritten for v0.2.70. F-Droid readiness docs refreshed locally. ARCHITECTURE.md and IMPROVEMENT_PLAN.md are current. Remaining: sync any version strings missed in non-tracked docs.
